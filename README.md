...
2. **Root Directory** → click **Edit** → enter `frontend` → **Continue** (**required**)
3. Confirm **Framework Preset** shows **Next.js** (from `frontend/package.json`)
4. Add **Neon Postgres** → `DATABASE_URL`
5. Set env vars: `NVIDIA_API_KEY`, `NCBI_EMAIL`, `NEXT_PUBLIC_SITE_URL` (your `https://….vercel.app` URL)
6. Deploy

  ...
  return (
    <div className="mx-auto max-w-xl px-5 py-10 lg:px-8 lg:py-14">
      ...
      <p className="mt-3 text-sm leading-relaxed text-ink-muted">
        Upload a paper you already have. Synapse extracts the text, summarizes it, and ranks
        evidence with our custom <strong className="font-medium text-ink">Research Evidence Rank (RER)</strong>{" "}
        algorithm, then lets you ask questions about it.
      </p>
